import React, { Fragment, Suspense, useContext, useEffect, useReducer, useState } from 'react';
...
import RecentOrderSlider from '../Dashboard/Dashboard/RecentOrderSlider';
...
import Products from './components/Restaurant';
...
const CustomerHome = () => {
              ...
              <div className="card-body pt-0 pb-2">
                <div className="card bg-primary blance-card">
                  <div className="card-body">
                    <h4 className="mb-0">
                      4 items in <i className="bi bi-cart2"></i>
                    </h4>
                    <h2>$12.000</h2>
                ...
                <div className="bb-border">
                  ...
                  <div className="d-flex  align-items-center justify-content-between mb-2">
                    <h4 className="mb-0">
                      ...
                      No. 132 Wilkison Road
                    </h4>
                    <Link to={'#'} className="btn btn-outline-primary btn-sm change">
                      Change
                    </Link>
                  </div>
                  <p>
                    {' '}
                    No. 132 Wilkison Road freetown Sierra Leone address was gotten from your current location at the time of using this application
                  </p>
                  <div className="d-flex">
                    ...
                    {/* <!-- Modal --> */}
                    <button type="button" className="btn btn-primary ms-2" onClick={() => setNotesModal(true)}>
                      Add Note
                    </button>
                    {/* <!-- Modal --> */}
                  </div>
                    ...
                    <div className="dlab-info">
                      ...
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <div className="quntity">
                          <button data-decrease onClick={() => handleCountMinus(item.id)}>
                            -
                          </button>
                          <input data-value type="text" value={item.number} />
                          <button data-increase onClick={() => handleCountAdd(item.id)}>
                            +
                          </button>
                        </div>
                      </div>
  ...
  return (
    ...
    //       <button type="button" className="btn btn-secondary" onClick={() => setDetailsModal(false)}>
    //         Close
    //       </button>
    ...
    //     </div>
    //     <div className="modal-footer">
    //       <button type="button" className="btn btn-secondary" onClick={() => setNotesModal(false)}>
    //         Close
    //       </button>
    //       <button type="button" className="btn btn-primary">
    //         Save changes
