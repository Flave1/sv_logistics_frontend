...
const RestaurantMenu = () => {
    ...
    return(
        <>
             <Tab.Container defaultActiveKey="Grid">
				<div className="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <Nav as="ul" className="grid-tab nav nav-pills" id="list-tab" role="tablist">
                        ...
                        <button type="button" className="btn btn-primary mt-3 mt-sm-0" data-target="#menuModal" onClick={() => setShowForm(!showForm)}>Add Menu</button>
                        &nbsp;
                        &nbsp;
                ...
                <Tab.Content>
                    <Tab.Pane eventKey="List">
                        <RestaurantMenuList menuList = {menuItem?.data} showForm = {showForm} setShowForm = {setShowForm} selectedItem = {selectedItem} setSelectedItem={setSelectedItem}/>
                    </Tab.Pane>
                    <Tab.Pane eventKey="Grid">
                        <div className="row">
                            {menuItem?.data.map((item, ind)=>(
            ...
            <Form show={showForm} setShowForm={setShowForm} dispatch={dispatch} categoryId = {menuCategory.categoryId} selectedItem={selectedItem} setSelectedItem={setSelectedItem}/>
        </>
    )
}
                ...
                <div className="modal-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="modal-inside">
                            ...
                            />
                            <label className="form-check-label" htmlFor="val-status">Status</label>
                        ...
                        <div className="modal-inside">
                            ...
                            />
                            <label className="form-check-label" htmlFor="val-status">Availability</label>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-default" onClick={() => setShowForm(!show)}>Close</button>
