...
import MenuCategorySlider from './category-slider';
import { useDispatch } from 'react-redux';
import { useState } from 'react';
import { useFormik } from 'formik';
import * as Yup from 'yup';
import { createCategoryAction } from '../../../../../store/actions/MenuActions';
...
const MenuCategory = () =>{
    ...
    return(
        <>
            <div className="row">
                <div className="col-xl-12">
                    <div className="d-flex align-items-center justify-content-between mb-4 flex-wrap">
                        ...
                        <button type="button" className="btn btn-primary mt-3 mt-sm-0" data-target="#categoryModal" onClick={() => setShowForm(!showForm)}>Add New Category</button>                                  
                    </div>
            ...
            <Form show={showForm} setShowForm={setShowForm} dispatch={dispatch}/>
...
function Form({ show, setShowForm, dispatch}) {
    ...
    return(
        <Modal className="modal fade" show={show} id="categoryModal">                
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLabel" >Add Menu Category</h5>
