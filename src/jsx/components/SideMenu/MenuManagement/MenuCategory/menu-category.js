...
import { createCategoryAction, getMenuCategoriesAction, getSingleMenuCategoryAction, updateCategoryMenuAction, deleteMenuCategoryAction } from '../../../../../store/actions/MenuActions';
            ...
            <div className="row">
                <div className="col-xl-12">
                    <div className="d-flex align-items-center justify-content-between mb-4 flex-wrap">
                        ...
                        <button type="button" className="btn btn-primary mt-3 mt-sm-0" data-target="#categoryModal" 
                            ...
                            <div className="card">
                                <div className='row mt-1'>
                                    <div className='col-md-6 text-left'>
                                        <button type="button" className="me-2 btn" id='deleteBtn' 
                                        onClick={() => {
                                        const id = item.id;
                                ...
                                />
                                <Link to={"/restaurant-menu/"+ item.id}><h6 className="mb-0 font-w500">{item.name}</h6></Link>
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
