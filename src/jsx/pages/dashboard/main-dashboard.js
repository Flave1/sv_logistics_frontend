...
import ApexBarChart from '../../components/Dashboard/Restaurant/ApexBarChart';
import OrderAreaChart from '../../components/Dashboard/Restaurant/OrderAreaChart';
import PerformanceChart from '../../components/Dashboard/Restaurant/PerformanceChart';
import PopularPieChart from '../../components/Dashboard/Restaurant/PopularPieChart';
import RestActiveUser from '../WidgetBasic/ActiveUser';
...
function MainDashboard() {
  ...
  useEffect(() => {
    getMenuCategoriesAction()(dispatch);
  }, [dispatch]);

  const [fetch, setFetch] = useState(null);
  socket.on(`get_dashboard_stats_${restaurantId}`, (response) => {
    setFetch(response);
  });
  useEffect(() => {
  ...
  useEffect(() => {
    const joinRoom = () => {
      if (socket) {
        socket.emit('join_room', { roomName: `get_dashboard_stats_${restaurantId}` });
      }
    };
    ...
    return () => {
      if (socket) {
        socket.emit('leave_room', { roomName: `get_dashboard_stats_${restaurantId}` }, (response) => {
          console.log(`left ${response}`);
        });
        socket.off(`get_dashboard_stats_${restaurantId}`);
      }
    };
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-3 col-lg-3 col-6">
                      ...
                      <ul className="d-flex align-items-center">
                        ...
                        <li className="font-w600 text-success ms-2">+0%</li>
                      </ul>
                    </div>
                    <div className="col-xl-2 col-lg-2 col-6">
                      ...
                      <ul className="d-flex align-items-center">
                        ...
                        <li className="font-w600 text-danger ms-2">-0%</li>
                      </ul>
                    </div>
                    {/* <div className="col-xl-3 align-self-center col-lg-3 col-3">
                      <div className="text-end text-sm-start text-xl-end text-nowrap">
                        <Link to={'withdrow'} className="btn btn-primary">
                          Withdraw{' '}
                          <svg className="ms-2" width="10" height="18" viewBox="0 0 11 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div className="card-body">
                  <div className="d-flex align-itens-center flex-xl-nowrap flex-wrap">
                    <div>
                      ...
                      <span>Application health is healthy</span>
                    </div>
                    <div>
                      <PerformanceChart />
                    </div>
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <Dropdown className="deliver-drop">
                      <Dropdown.Toggle as="div" className="form-control ms-0 default-select border deliver-drop-toggle style2 i-false">
                        {'Year'} <i className="fas fa-chevron-down drop-toggle-icon" />
                      </Dropdown.Toggle>
                      <Dropdown.Menu>
            ...
            <div className="col-xl-12 col-sm-6">
              <div className="card">
                <div className="card-body pb-0">
                  ...
                  <PopularPieChart />
                  {/* pie chart */}
                  <h6 className="font-w700 mb-3">Categories</h6>
